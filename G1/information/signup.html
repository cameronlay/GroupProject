			...
			<table id="signuptable">
				<tbody>
					<tr>
						...
						<td><input type="text" placeholder="abc@example.abc" 
                                                           onblur="warnEmailType()" id="mail" name="Email" class="formfield"/></td>
					</tr>
					<tr>
					...
					<tr> 
						...
						<td><input type="text" id="login" name="Username" 
                                                           onblur="warnUsername()" class="formfield"/></td>
					</tr>
					<tr>
					...
					<tr> 
						...
						<td><input type="password" placeholder="********"
                                                           onblur="warnPassword()" id="password" name="Password" class="formfield"/></td>
					</tr>
					<tr>
					...
					<tr> 
						...
						<td><input type="password" placeholder="********" 
                                                           onblur="warnConfirm()" id="password2" name="Password" class="formfield"/></td>
					</tr>
					<tr>
